...
if (!isset($args['global_variable']) || $args['global_variable'] !== false) {
    ...
    $args['intro_text'] = sprintf(__('<i style="color:#f18500;" class="el el-lock"></i> <a href=\"https://www.themely.com/themes/parallel/\" target=\"_blank=\" style=\"color:#f18500;\">Upgrade to Parallel PRO</a> to unlock additional sections, features and settings.', 'parallel') , $v);
}
else {
