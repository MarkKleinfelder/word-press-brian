...
class Parallel_Welcome {
	...
	public function parallel_welcome_screen() {
		...
		<div class="wrap about-wrap theme-welcome">
            ...
            <h1><?php esc_html_e('Welcome to Parallel', 'parallel'); ?> <span><?php esc_html_e('VERSION 1.3.8.3', 'parallel'); ?></span></h1>

            <div class="about-text"><?php esc_html_e('Parallel is a one-page multipurpose theme for professionals, agencies and businesses. Its strength lies in displaying content on a single page in a simple and elegant manner. It\'s super easy to customize and allows you to create a stunning website in minutes.', 'parallel'); ?></div>
